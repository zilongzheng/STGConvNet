...
def main():
    ...
    parser.add_argument('-sz', '--image_size', type=int, default=100)

    # training hyper-parameters
    parser.add_argument('-num_epochs', type=int, default=1000)
    parser.add_argument('-batch_size', type=int, default=1)
    parser.add_argument('-sample_batch', type=int, default=3, help='number of synthesized results for each batch of training data')
